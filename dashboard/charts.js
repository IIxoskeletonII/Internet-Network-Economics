...
const COLORS = {
  ...
  ochre: '#b07d2a',
  blue: '#2a4a7f',
  muted: 'rgba(10,14,26,0.56)',
  line: 'rgba(10,14,26,0.14)',
  usdc: '#2a4a7f',
  usdt: '#1f5e4a'
};
function fmt(n, d = 2) {
...
function Axis({
  ...
  return /*#__PURE__*/React.createElement("g", {
    ...
    className: "axis"
  }, orient === 'bottom' && /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("line", {
    x1: 0,
    x2: w,
    y1: 0,
    y2: 0
    ...
    y: 16,
    textAnchor: "middle"
  }, ff(t)))), label && /*#__PURE__*/React.createElement("text", {
    x: w / 2,
    y: 36,
    textAnchor: "middle",
    style: {
  ...
  }, label)), orient === 'left' && /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("line", {
    x1: 0,
    x2: 0,
    y1: 0,
    y2: h
    ...
    transform: `rotate(-90) translate(${-h / 2},${-44})`,
    textAnchor: "middle",
    style: {
      fontSize: 10,
      letterSpacing: '0.1em',
...
function GridLines({
  ...
  return /*#__PURE__*/React.createElement("g", {
    transform: `translate(${x},${y})`
  }, ticks.map((t, i) => orient === 'h' ? /*#__PURE__*/React.createElement("line", {
    key: i,
    className: "grid-line",
    x1: 0,
    x2: w,
...
function ScatterLog({
  ...
  const xTicks = [];
  for (let p = Math.log10(xMin); p <= Math.log10(xMax); p++) xTicks.push(Math.pow(10, p));
  const yTicks = [];
  for (let p = Math.log10(yMin); p <= Math.log10(yMax); p++) yTicks.push(Math.pow(10, p));
  const xMinor = [];
  for (let p = Math.log10(xMin); p < Math.log10(xMax); p++) {
    xMinor.push(2 * Math.pow(10, p));
    xMinor.push(5 * Math.pow(10, p));
  }
  const yMinor = [];
  for (let p = Math.log10(yMin); p < Math.log10(yMax); p++) {
    yMinor.push(2 * Math.pow(10, p));
    yMinor.push(5 * Math.pow(10, p));
  }
  return /*#__PURE__*/React.createElement("svg", {
  ...
  }, yMinor.filter(v => v >= yMin && v <= yMax).map((v, i) => /*#__PURE__*/React.createElement("line", {
    key: 'ym' + i,
    x1: 0,
    x2: w,
    y1: sy(v),
    ...
    strokeWidth: 0.4,
    opacity: 0.5
  })), xMinor.filter(v => v >= xMin && v <= xMax).map((v, i) => /*#__PURE__*/React.createElement("line", {
    key: 'xm' + i,
    x1: sx(v),
    x2: sx(v),
    y1: 0,
    ...
    return /*#__PURE__*/React.createElement("line", {
      x1: sx(x0),
      y1: sy(Math.max(yMin, Math.min(yMax, y0))),
      x2: sx(x1),
      y2: sy(Math.max(yMin, Math.min(yMax, y1))),
    ...
    orient: "bottom",
    label: xLabel,
    fmt: v => '10^' + Math.round(Math.log10(v))
  }), /*#__PURE__*/React.createElement(Axis, {
    x: margin.l,
    y: margin.t,
    w: w,
...
function TimeSeries({
  ...
  return /*#__PURE__*/React.createElement("svg", {
    ...
    const path = s.data.map((p, j) => {
      const px = sx(new Date(p[0]).getTime()),
        py = sy(p[1]);
    ...
    }), s.showPoints && s.data.map((p, j) => /*#__PURE__*/React.createElement("circle", {
      key: j,
      cx: sx(new Date(p[0]).getTime()),
      cy: sy(p[1]),
      r: 2,
      fill: s.color
    })));
  }), annotations && annotations.map((a, i) => /*#__PURE__*/React.createElement("g", {
    key: i,
    transform: `translate(${sx(new Date(a.date).getTime())},${sy(a.y)})`
  ...
  }, a.label)))), /*#__PURE__*/React.createElement(Axis, {
    x: margin.l,
    y: margin.t + h,
    w: w,
    h: h,
    ...
    ticks: xTicks,
    orient: "bottom",
    fmt: v => new Date(v).getUTCFullYear()
  }), /*#__PURE__*/React.createElement(Axis, {
    x: margin.l,
    y: margin.t,
    w: w,
...
function CoefPlot({
  ...
  return /*#__PURE__*/React.createElement("svg", {
    ...
    }, "\u03B2=", s.beta.toFixed(4), " \xB7 p=", fmtP(s.p)));
  })), /*#__PURE__*/React.createElement(Axis, {
    x: margin.l,
    y: margin.t + h,
    w: w,
    ...
    ticks: xTicks,
    orient: "bottom",
    label: "coefficient on baseline \xD7 post-2022",
    fmt: v => v.toFixed(4)
  }));
}
...
function CostBars({
  ...
  const yTicks = logY ? [0.01, 0.1, 1, 10, 100, 1000].filter(v => v <= maxV * 1.2) : Array.from({
    length: 6
  }, (_, i) => maxV * i / 5);
  return /*#__PURE__*/React.createElement("svg", {
    className: "chart",
    ...
    }, fmt$(r.value, r.value < 10 ? 2 : 0)), /*#__PURE__*/React.createElement("text", {
      x: x + barW / 2,
      y: h + 18,
      textAnchor: "middle",
      style: {
    ...
    }, r.label), r.sub && /*#__PURE__*/React.createElement("text", {
      x: x + barW / 2,
      y: h + 34,
      textAnchor: "middle",
      style: {
    ...
    orient: "left",
    label: "cost (usd, log)",
    fmt: v => '$' + (v >= 1 ? v.toFixed(0) : v.toFixed(2))
  }));
}
...
function ScatterLnPlot({
  ...
  width = 720,
  height = 440,
  xLabel = 'log(Active Addresses)',
  yLabel = 'log(Transfer Count)',
  xDomain,
  yDomain,
  annotations = [],
  margin = {
  ...
  return /*#__PURE__*/React.createElement("svg", {
    ...
    key: 's' + si
  }, s.points.filter(p => p[0] > 0 && p[1] > 0).map((p, i) => /*#__PURE__*/React.createElement("circle", {
    key: i,
    cx: sx(Math.log(p[0])),
    cy: sy(Math.log(p[1])),
    r: s.r || 1.6,
  ...
  }), annotations.map((a, i) => /*#__PURE__*/React.createElement("g", {
    key: 'a' + i,
    transform: `translate(${sx(a.lnX)},${sy(a.lnY)})`
  }, a.arrowTo && (() => {
  ...
  }, a.label)))), /*#__PURE__*/React.createElement("g", {
    transform: `translate(${margin.l},${margin.t + h})`
  }, /*#__PURE__*/React.createElement("line", {
    x1: 0,
    x2: w,
    y1: 0,
  ...
  }, xLabel)), /*#__PURE__*/React.createElement("g", {
    transform: `translate(${margin.l},${margin.t})`
  }, /*#__PURE__*/React.createElement("line", {
    x1: 0,
    x2: 0,
